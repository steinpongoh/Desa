...
<section class="event" id="event">
    <div class="container">
        ...
        <p class="text-center" data-aos="fade-left">Sistem informasi Desa Tondangow menyediakan informasi-informasi
            terkait Event/Acara yang ada di Desa Tondangow</p>
            ...
            <?php foreach ($query as $event) { ?>
                <div class="col">
                    <a href="detailEvent.php?id=<?= $event['id'] ?>" class="text-decoration-none fs-5">
                        <div class="card card-event w-100 h-100">
