...
if (isset($_POST['submit'])) {
    if (tambahBerita($_POST, $_FILES) > 0) {
        ...
        echo "<script>
            ...
            document.location.href='../models/tambahBerita.php'
        </script>";
    }
}
?>
                ...
                <div class="card-body">
                    <form name="form" id="form" action="#" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <input name="judul_berita" id="judul_berita" autocomplete="off" type="text"
                                class="form-control" placeholder="Tuliskan judul berita" required>
                        </div>
                        <div class="form-group">
                            <label for="tanggal_berita">Tanggal Berita</label>
                            <input name="tanggal_berita" id="tanggal_berita" autocomplete="off" type="datetime-local"
                                class="form-control" placeholder="..." required>
                        </div>
                        <div class="form-group">
                            <label for="detail_berita">Detail Berita</label>
                            <textarea cols="4" rows="4" form="form" name="detail_berita" id="detail_berita"
                                autocomplete="off" type="text" class="form-control" placeholder="Tambahkan detail..."
                                required></textarea>
                        </div>
                        <div class="mb-3">
