                ...
                <div class="card-body">
                    <form name="form" id="form" action="#" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <input name="caption" id="caption" autocomplete="off" type="text" class="form-control"
                                placeholder="..." required>
                        </div>
                        <div class="form-group">
                            <label for="tanggal_upload">Tanggal</label>
                            <input name="tanggal_upload" id="tanggal_upload" autocomplete="off" type="datetime-local"
