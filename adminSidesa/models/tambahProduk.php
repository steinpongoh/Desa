                ...
                <div class="card-body">
                    <form name="form" id="form" action="#" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input name="nama_produk" id="nama_produk" autocomplete="off" type="text"
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input id="harga" name="harga" type="text" class="form-control harga"
                        ...
                        <div class="form-group">
                            ...
                            <textarea cols="4" rows="4" form="form" name="detail_produk" id="detail_produk"
