...
if (isset($_POST['submit'])) {
    if (tambahKeluarga($_POST) > 0) {
        ...
        echo "
            ...
            document.location.href='../models/tambahKeluarga.php'
            </script> 
        ";
    }
}
                ...
                <div class="card-body">
                    <form action="#" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <input name="kartu_keluarga" id="kartu_keluarga" autocomplete="off" type="number"
                                class="form-control" placeholder="..." required>
                        </div>
                        <div class="form-group">
                            <label for="kepala_keluarga">Nama Kepala Keluarga</label>
                            <input name="kepala_keluarga" id="kepala_keluarga" autocomplete="off" type="text"
                                class="form-control" placeholder="..." required>
                        </div>
