                ...
                <div class="card-body">
                    <form name="form" id="form" action="#" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <input name="judul_acara" id="judul_acara" autocomplete="off" type="text"
                                class="form-control" placeholder="..." required>
                        </div>
                        <div class="form-group">
                            <label for="detail_acara">Detail Acara</label>
                            <textarea cols="4" rows="4" form="form" name="detail_acara" id="detail_acara"
                                autocomplete="off" type="text" class="form-control" placeholder required></textarea>
                        </div>
                        <div class="form-group">
                            <label for="lokasi">Lokasi</label>
                            <input name="lokasi" id="lokasi" autocomplete="off" type="text" class="form-control"
                                placeholder="..." required>
                        </div>
                        <div class="form-group">
                            <label for="tanggal_acara">Tanggal Acara</label>
                            <input name="tanggal_acara" id="tanggal_acara" autocomplete="off" type="date"
                                class="form-control" placeholder="..." required>
                        </div>
                        <div class="mb-3">
